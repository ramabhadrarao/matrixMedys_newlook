...
router.post('/:hospitalId/contacts', authenticate, checkPermission('hospitals', 'create'), contactValidation, validate, createHospitalContact);
...
router.delete('/:hospitalId/contacts/:contactId', authenticate, checkPermission('hospitals', 'delete'), deleteHospitalContact);
